...
tl1
  .to(".box1", { rotation: 225, x: 900, y: 200, duration: 1 })
  .to(".box2", { rotation: 225, x: 900, y: 200, duration: 1 })
  .to(".box3", { rotation: 225, x: 900, y: 200, duration: 1 });
...
tl2
  .to(".box4", { rotation: 225, x: 900, y: 200, duration: 1 }, 6)
  .to(".box5", { rotation: 225, x: 900, y: 200, duration: 1 }, "-=0.75")
  .to(".box6", { rotation: 225, x: 900, y: 200, duration: 1 }, "+=0.5");
...
tl3
  .to(".box7", { rotation: 225, x: 900, y: 200, duration: 1 })
  .to(".box8", { rotation: 225, x: 900, y: 200, duration: 2 })
  .to(".box9", { rotation: 225, x: 900, y: 200, duration: 1 });
